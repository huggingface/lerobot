...
from lerobot.utils.import_utils import _reachy_mini_available, require_package

from .configuration_reachy_mini import ReachyMiniConfig

# Install with `pip install "lerobot[reachy_mini]"`.
if TYPE_CHECKING or _reachy_mini_available:
...
class ReachyMini(Robot):
    ...
    def __init__(self, config: ReachyMiniConfig):
        require_package("reachy_mini", extra="reachy_mini")

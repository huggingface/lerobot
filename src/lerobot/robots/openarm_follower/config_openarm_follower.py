...
class OpenArmFollowerConfigBase:
    ...
    # Motor configuration for OpenArms (7 DOF per arm), see DEFAULT_MOTOR_CONFIG
    motor_config: dict[str, tuple[int, int, str]] = field(default_factory=lambda: dict(DEFAULT_MOTOR_CONFIG))

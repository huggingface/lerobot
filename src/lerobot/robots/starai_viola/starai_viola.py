...
class StaraiViola(Robot):
    ...
    def __init__(self, config: StaraiViolaConfig):
        ...
        self.bus = StaraiMotorsBus(
            ...
            motors={
                ...
                "Motor_1": Motor(2, "sts3215", norm_mode_body),
                "Motor_2": Motor(3, "sts3215", norm_mode_body),
                "Motor_3": Motor(4, "sts3215", norm_mode_body),
                "Motor_4": Motor(5, "sts3215", norm_mode_body),
                "Motor_5": Motor(5, "sts3215", norm_mode_body),
                "Motor_6": Motor(5, "sts3215", norm_mode_body),

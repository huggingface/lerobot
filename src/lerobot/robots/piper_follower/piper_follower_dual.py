...
from .config_piper_follower_dual import PIPERFollowerDualConfig
...
class PIPERFollowerDual(Robot):
    config_class = PIPERFollowerDualConfig
    name = "piper_follower_dual"

    def __init__(self, config: PIPERFollowerDualConfig):
    ...
    def connect(self) -> None:
        ...
        print("piper follower dual connected")

...
class BiRebotB601Follower(BimanualMixin, Robot):
    ...
    def __init__(self, config: BiRebotB601FollowerConfig):
        ...
        left_arm_config = RebotB601FollowerRobotConfig(
            ...
            safe_home_on_disconnect=config.left_arm_config.safe_home_on_disconnect,
            safe_home_target=config.left_arm_config.safe_home_target,
            safe_home_duration_s=config.left_arm_config.safe_home_duration_s,
            safe_home_rate_hz=config.left_arm_config.safe_home_rate_hz,
            safe_home_gripper_pos=config.left_arm_config.safe_home_gripper_pos,
            safe_home_gripper_dwell_s=config.left_arm_config.safe_home_gripper_dwell_s,
        ...
        right_arm_config = RebotB601FollowerRobotConfig(
            ...
            safe_home_on_disconnect=config.right_arm_config.safe_home_on_disconnect,
            safe_home_target=config.right_arm_config.safe_home_target,
            safe_home_duration_s=config.right_arm_config.safe_home_duration_s,
            safe_home_rate_hz=config.right_arm_config.safe_home_rate_hz,
            safe_home_gripper_pos=config.right_arm_config.safe_home_gripper_pos,
            safe_home_gripper_dwell_s=config.right_arm_config.safe_home_gripper_dwell_s,

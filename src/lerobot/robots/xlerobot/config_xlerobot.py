...
class XLerobotConfig(RobotConfig):
    ...
    port1: str = "/dev/tty.usbmodem5AB01796671"  # port to connect to the bus (so101 + head camera) left arm
    port2: str = "/dev/tty.usbmodem5AB01796541"  # port to connect to the bus (same as lekiwi setup) right arm

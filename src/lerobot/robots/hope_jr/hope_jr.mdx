...
You can now record a LeRobot dataset using the following command. For reference, you can see an example of a recorded HopeJR dataset at [nepyope/hopejr_test](https://huggingface.co/datasets/nepyope/hopejr_test):

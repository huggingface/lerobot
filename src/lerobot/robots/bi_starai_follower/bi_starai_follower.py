...
from lerobot.robots.starai_viola import StaraiViola
from lerobot.robots.starai_viola.config_starai_viola import StaraiViolaConfig
...
class BiStaraiFollower(Robot):
    ...
    def __init__(self, config: BiStaraiFollowerConfig):
        ...
        left_arm_config = StaraiViolaConfig(
        ...
        right_arm_config = StaraiViolaConfig(
        ...
        self.left_arm = StaraiViola(left_arm_config)
        self.right_arm = StaraiViola(right_arm_config)

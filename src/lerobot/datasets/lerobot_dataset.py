...
class LeRobotDataset(torch.utils.data.Dataset):
    ...
    def save_episode(self, episode_data: dict | None = None, parallel_encoding: bool = True) -> bool:
        ...
        Returns:
            ``True`` if the episode was committed, ``False`` if it was discarded
            (e.g. a frame shortfall).

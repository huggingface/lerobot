...
def build_rollout_context(
    ...
    # Route every scalar motor feature to the policy as state. The robot
    # observation already exposes position, velocity, and torque channels,
    # and some policies are trained on the full state vector.

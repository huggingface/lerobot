...
class EditDatasetConfig:
    repo_id: str
    operation: DeleteEpisodesConfig | SplitConfig | MergeConfig | RemoveFeatureConfig | ConvertToVideoConfig | InfoConfig
    root: str | None = None
...
def edit_dataset(cfg: EditDatasetConfig) -> None:
    ...
    if operation_type == "delete_episodes":
        ...
        raise ValueError(
            ...
            f"Available operations: delete_episodes, split, merge, remove_feature, convert_to_video, info"
        )

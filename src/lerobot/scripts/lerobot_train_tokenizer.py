...
def process_episode(args):
    ...
    try:
        ...
        for abs_idx in range(from_idx, to_idx):
            ...
            if dataset._reader._absolute_to_relative_idx is not None:
                if abs_idx not in dataset._reader._absolute_to_relative_idx:
                    # this episode's frames aren't in the filtered dataset
                    return None
                rel_idx = dataset._reader._absolute_to_relative_idx[abs_idx]
            else:
                rel_idx = abs_idx

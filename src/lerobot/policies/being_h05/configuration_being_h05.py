...
def _being_h05_default_recipe() -> dict:
...
class BeingH05Config(PreTrainedConfig):
    ...
    recipe: dict | None = field(default_factory=lambda: _being_h05_default_recipe())
    ...
    def rebuild_pretrained_processors(self) -> bool:
        return bool(self.use_language_recipe or self.recipe_path) or any(

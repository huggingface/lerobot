...
def make_dynamicvla_pre_post_processors(
    ...
    """
    Constructs pre-processor and post-processor pipelines for the DynamicVLA policy.
    ...
    Args:
        config: The configuration object for the DynamicVLA policy.
...
@ProcessorStepRegistry.register(name="dynamicvla_new_line_processor")
class DynamicVLANewLineProcessor(ComplementaryDataProcessorStep):
    """

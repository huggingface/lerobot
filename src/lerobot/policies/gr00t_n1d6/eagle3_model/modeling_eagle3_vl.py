...
class Eagle3_VLPreTrainedModel(PreTrainedModel):  # noqa: N801
...
class Eagle3_VLForConditionalGeneration(Eagle3_VLPreTrainedModel, GenerationMixin):  # noqa: N801
    config_class = Eagle3_VLConfig
    ...
    def __init__(self, config: Eagle3_VLConfig, vision_model=None, language_model=None):
        ...
        if vision_model is not None:
            ...
            if config.vision_config.model_type == "intern_vit_6b":
                self.vision_model = InternVisionModel(config.vision_config)  # noqa: F821
                ...
                self.vision_model = RADIOModel(config.vision_config)  # noqa: F821
        ...
        if language_model is not None:
            ...
            if config.text_config.architectures[0] == "LlamaForCausalLM":
                ...
                self.language_model = Phi3ForCausalLM(config.text_config)  # noqa: F821
    ...
    def forward(
        ...
        B, N, C = input_embeds.shape  # noqa: N806
    ...
    def pixel_shuffle_back(self, vit_embeds, spatial_shapes):
        ...
        B, N, C = vit_embeds.shape  # noqa: N806

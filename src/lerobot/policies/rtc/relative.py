...
def reanchor_relative_rtc_prefix(
    ...
    state_index_map = relative_step._resolve_state_index_map(action_cpu.shape[-1], state.shape[-1])
    relative_actions = to_relative_actions(action_cpu, state, mask, state_index_map)

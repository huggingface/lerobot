...
class PI05Pytorch(nn.Module):  # see openpi `PI0Pytorch`
    ...
    def embed_prefix(
        self, images, img_masks, tokens, attention_mask, padded_mask
    ...
    def forward(self, images, img_masks, tokens, masks) -> Tensor:
        ...
        outputs = self.paligemma_with_expert.paligemma.forward(
            input_ids=None,
            token_type_ids=None,
...
class PI05Policy(PreTrainedPolicy):
    ...
    def predict_action_chunk(self, batch: dict[str, Tensor], **kwargs: Unpack[ActionSelectKwargs]) -> Tensor:
        ...
        # now we must call .generate() method on the model
        # then detoknize

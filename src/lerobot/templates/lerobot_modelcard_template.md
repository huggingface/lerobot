...
{% elif model_name == "g05" %}
[OpenGalaxea G0.5](https://opengalaxea.github.io/G05/) is a Qwen3.5-based VLA that emits optional embodied reasoning and actions in one unified stream. The author model and weights use the separate non-commercial G0.5 Community License; inspect the checkpoint's license before use.
{% else %}

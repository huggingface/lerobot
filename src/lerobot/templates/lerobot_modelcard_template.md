...
{% elif model_name == "openeai" %}
[OpenEAI-VLA](https://arxiv.org/abs/2606.03392) is a Vision-Language-Action policy built on a Qwen3-VL backbone with a DiT action head trained via flow matching. It supports per-dataset subset branching for multi-source training.
{% else %}

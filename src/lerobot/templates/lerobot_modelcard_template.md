...
{% elif model_name == "hy_vla" %}
[Hy-Embodied-0.5-VLA](https://github.com/Tencent-Hunyuan/Hy-Embodied-0.5-VLA) is a bimanual vision-language-action policy that combines the Hy-Embodied-0.5 vision-language model with a flow-matching action expert to predict dual-arm pose-action chunks.
{% else %}

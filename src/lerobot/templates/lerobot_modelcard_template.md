...
{% elif model_name == "being_h05" %}
[Being-H0.5](https://github.com/BeingBeyond/Being-H) is a cross-embodiment vision-language-action policy with a semantic 200D state/action space and mixture-of-flow action generation.
{% else %}

...
class SourcceyLeader(Teleoperator):
    """
    [Sourccey Leader Teleoperator] designed by Vulcan
    """

    config_class = SourcceyLeaderConfig
    name = "sourccey_leader"

    def __init__(self, config: SourcceyLeaderConfig):

...
from lerobot.teleoperators.so_leader import SOLeaderBase
...
class BiSOLeader(Teleoperator):
    ...
    def __init__(self, config: BiSOLeaderConfig):
        ...
        self.left_arm = SOLeaderBase(self.config.left_arm_config)
        self.right_arm = SOLeaderBase(self.config.right_arm_config)

...
class BiStaraiLeader(Teleoperator):
    ...
    def __init__(self, config: BiStaraiLeaderConfig):
        ...
        left_arm_config = STARAILeaderConfig(
            id=f"{config.id}_left" if config.id else None,
            calibration_dir=config.calibration_dir,
            port=config.left_arm_port,
        )

        right_arm_config = STARAILeaderConfig(
            id=f"{config.id}_right" if config.id else None,
            calibration_dir=config.calibration_dir,
            port=config.right_arm_port,
        )

        self.left_arm = STARAILeader(left_arm_config)
        self.right_arm = STARAILeader(right_arm_config)

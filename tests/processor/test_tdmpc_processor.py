...
def test_tdmpc_processor_normalization():
    ...
    assert postprocessed[TransitionKey.ACTION][TransitionKey.ACTION.value].shape == (1, 6)
...
def test_tdmpc_processor_batch_data():
    ...
    assert processed[TransitionKey.ACTION][TransitionKey.ACTION.value].shape == (batch_size, 6)

...
MODEL_TEST_PARAMS = [
    # PI0 models
    ("lerobot/pi0_base", "PI0", PI0Policy),
    ("lerobot/pi0_libero", "PI0", PI0Policy),
    # PI0.5 models
    ("lerobot/pi05_base", "PI0.5", PI05Policy),
    ("lerobot/pi05_libero", "PI0.5", PI05Policy),
]
...
def test_all_base_models_hub_loading(model_id, model_type, policy_class):
    ...
    Args:
        model_id: HuggingFace model ID (e.g., "lerobot/pi0_base")

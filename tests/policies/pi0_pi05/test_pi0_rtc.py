...
def test_pi0_rtc_alex_soare_optimization():
    """Test PI0 auto-sets max_guidance_weight to num_inference_steps (Alex Soare optimization)."""
    set_seed(42)
    ...
    print("✓ PI0 Alex Soare optimization: Test passed")
...
def test_pi0_rtc_explicit_max_guidance_weight():
    ...
    print("✓ PI0 explicit max_guidance_weight: Test passed")

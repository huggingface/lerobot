...
from lerobot.utils.logger_factory import CompositeLogger, create_experiment_loggers
...
def test_create_experiment_loggers_wandb_only(
    mock_wandb_logger: Mock, sample_config: TrainPipelineConfig
) -> None:
...
def test_create_experiment_loggers_mlflow_only(
    mock_mlflow_logger: Mock, mock_wandb_logger: Mock, sample_config: TrainPipelineConfig
) -> None:
...
@patch("lerobot.utils.logger_factory.WandBLogger")
@patch("lerobot.utils.mlflow_utils.MLflowLogger")
def test_create_experiment_loggers_both_enabled(
    mock_mlflow_logger: Mock, mock_wandb_logger: Mock, sample_config: TrainPipelineConfig
) -> None:
...
@patch("lerobot.utils.logger_factory.WandBLogger")
def test_create_experiment_loggers_wandb_init_failure(
    mock_wandb_logger: Mock, sample_config: TrainPipelineConfig
) -> None:

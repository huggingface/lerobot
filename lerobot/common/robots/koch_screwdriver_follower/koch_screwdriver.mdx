...
```python
from lerobot.common.robots.koch_follower import KochScrewdriverFollower, KochScrewdriverFollowerConfig

config = KochScrewdriverFollowerConfig(
    port="/dev/tty.usbmodem575E0031751",
    id="my_awesome_follower_arm",
)
follower = KochScrewdriverFollower(config)
...
```python
from lerobot.common.robots.koch_follower import KochScrewdriverFollowerConfig, KochScrewdriverFollower

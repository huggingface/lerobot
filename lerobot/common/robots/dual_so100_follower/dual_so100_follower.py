...
class DualSO100Follower(Robot):
    """
    Dual SO-100 Follower Arms - manages two SO-100 arms for bimanual tasks
    """

    config_class = DualSO100FollowerConfig
    name = "dual_so100_follower"

    def __init__(self, config: DualSO100FollowerConfig):
    ...
    def _get_left_calibration(self):
        ...
        left_calibration_path = (
            # Path("/home/daifengji/.cache/huggingface/lerobot/calibration/robots/so100_follower")

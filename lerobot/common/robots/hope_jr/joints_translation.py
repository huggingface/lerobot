...
def homonculus_glove_to_hope_jr_hand(glove_action: dict[str, float]) -> dict[str, float]:
    return {
        ...
        "index_pip_dip.pos": glove_action["index_pip_dip.pos"],
        ...
        "middle_pip_dip.pos": glove_action["middle_pip_dip.pos"],
        ...
        "ring_pip_dip.pos": glove_action["ring_pip_dip.pos"],
        ...
        "pinky_pip_dip.pos": glove_action["pinky_pip_dip.pos"],
    }

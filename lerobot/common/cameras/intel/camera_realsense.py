...
class RealSenseCamera(Camera):
    ...
    def connect(self, do_warmup_read: bool = True):
        ...
        try:
            ...
            raise ConnectionError(
                ...
                f"Run 'python lerobot/find_cameras.py list-cameras' for details."
            ) from e
    ...
    def read_depth(self, timeout_ms: int = 5000) -> np.ndarray:
        ...
        depth_map_processed = self._postprocess_image(depth_map, depth=True)
    ...
    def _postprocess_image(
        self, image: np.ndarray, color_mode: ColorMode | None = None, depth: bool = False
    ) -> np.ndarray:
        """

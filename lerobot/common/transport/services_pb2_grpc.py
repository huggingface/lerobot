...
if _version_not_supported:
    raise RuntimeError(
        ...
        + " but the generated code in lerobot/common/transport/services_pb2_grpc.py depends on"
...
class LearnerServiceServicer:
    ...
    def SendInteractionMessage(self, request, context): # noqa: N802
...
def add_LearnerServiceServicer_to_server(servicer, server): # noqa: N802
    rpc_method_handlers = {
...
class LearnerService:
    ...
    @staticmethod
    def SendInteractionMessage( # noqa: N802
        request,
        target,
        options=(),

...
class LivekitManipulatorRobot(ManipulatorRobot):
    ...
    def __init__(self, config: LivekitManipulatorRobotConfig, **kwargs):
    ...
    def publish_leader_position(self, leader_pos: dict[str, torch.Tensor]) -> None:
        ...
        try:
            ...
            async def send_packet():
                await self.room.local_participant.publish_data(data, reliable=False, topic="leader")

...
@dataclass
class MoveIt2ManipulatorConfig:
    ...
    # The MoveIt2 end effector link name.
...
@dataclass
class JoystickListenerConfig:
    # Namespace used by the joystick listener node
    namespace: str = ""
...
@dataclass
class MoveIt2ManipulatorRobotConfig(RobotConfig):
    calibration_dir: str = ".cache/calibration/moveit2_default"

    cameras: dict[str, CameraConfig] = field(default_factory=lambda: {})

    leader_arms: dict[str, JoystickListenerConfig] = field(
        default_factory=lambda: {
            "main": JoystickListenerConfig(),
        }
    )

    follower_arms: dict[str, MoveIt2ManipulatorConfig] = field(
        default_factory=lambda: {
            "main": MoveIt2ManipulatorConfig(),
        }
    )

    # The ratio between the controller input and the velocity of the end effector.

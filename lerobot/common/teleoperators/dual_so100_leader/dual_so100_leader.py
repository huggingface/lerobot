...
class DualSO100Leader(Teleoperator):
    """
    Dual SO-100 Leader Arms - manages two SO-100 leader arms for bimanual teleoperation
    """

    config_class = DualSO100LeaderConfig
    name = "dual_so100_leader"

    def __init__(self, config: DualSO100LeaderConfig):
    ...
    def _get_left_calibration(self):
        ...
        left_calibration_path = (
            # Path("/home/daifengji/.cache/huggingface/lerobot/calibration/teleoperators/so100_leader")
            # / f"{self.config.left_id}.json"
            self.calibration_dir / f"{self.config.left_id}.json"
        )
    ...
    def _get_right_calibration(self):
        ...
        right_calibration_path = (
            ...
            self.calibration_dir / f"{self.config.right_id}.json"
        )

...
if _version_not_supported:
    raise RuntimeError(
        ...
        + " but the generated code in async_inference_pb2_grpc.py depends on"
...
class AsyncInferenceStub:
    ...
    def __init__(self, channel):
        ...
        self.SelectAction = channel.unary_unary(
            "/async_inference.AsyncInference/SelectAction",
            request_serializer=async__inference__pb2.SelectActionRequest.SerializeToString,
            response_deserializer=async__inference__pb2.SelectActionResponse.FromString,
            _registered_method=True,
        )
        self.SelectActionStream = channel.stream_stream(
            "/async_inference.AsyncInference/SelectActionStream",
            request_serializer=async__inference__pb2.SelectActionRequest.SerializeToString,
            response_deserializer=async__inference__pb2.SelectActionResponse.FromString,
            _registered_method=True,
        )
...
def add_AsyncInferenceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        "SelectAction": grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=async__inference__pb2.SelectActionRequest.FromString,
            response_serializer=async__inference__pb2.SelectActionResponse.SerializeToString,
        ),
...
class AsyncInference:
    ...
    def SelectAction(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/async_inference.AsyncInference/SelectAction",
            async__inference__pb2.SelectActionRequest.SerializeToString,
            async__inference__pb2.SelectActionResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,

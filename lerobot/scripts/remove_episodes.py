...
def main():
    ...
    updated_card.save(updated_dataset.root / REPOCARD_NAME)
    logging.info(
    ...
    if args.push_to_hub:
        ...
        updated_dataset.push_to_hub(
            tags=args.tags, private=args.private, license=args.license, branch=args.branch
        )
        # The card is not pushed by default if the dataset already exists.
        # Therefore, we make sure to push it here to ensure the card is up-to-date.

"""
LeRobot Target Annotator — ZMQ Publisher  [v4]
===============================================
...
Run:
    python annotate_stream_v4.py
    python annotate_stream_v4.py --zmq-port 5556 --zmq-name wrist_annotated
    python annotate_stream_v4.py --no-zmq          # disable ZMQ (annotation only)
    python annotate_stream_v4.py --camera 1 --classes "cup,bottle,toy"
...
def main():
    parser = argparse.ArgumentParser(description="YOLO-World annotation stream v4 — ZMQ publisher")
    ...
    while True:
        ...
        cv2.imshow("Annotation Stream v4", display)
        ...
        if key == ord('q'):
            ...
            if pick_zone is not None:
                ...
                roi = cv2.selectROI("Annotation Stream v4", frame,

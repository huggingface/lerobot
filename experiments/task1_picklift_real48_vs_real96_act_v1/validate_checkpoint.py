...
def main() -> None:
    parser = argparse.ArgumentParser(description="Offline validate a fixed Task1 Real48/Real96 ACT checkpoint")
    ...
    result = {
        "schema": "task1_picklift_real48_real96_act_offline_checkpoint_validation_v1",
        "status": "pass",

...
RESULT_EVIDENCE = Path(
    "/home/ubuntu24/Teleop/artifacts/evidence/"
    "task1_picklift_real24_questsim48_v7_act_v1/training_result_v1"
)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Freeze controlled Real24 + Sim48-v7 results")
    parser.add_argument(
        "--run-summary",
        type=Path,
    ...
    result_files = [
        EXPERIMENT_ROOT / "combined72_result.json",
    ...
    hashes = {
        "schema": "task1_picklift_real24_questsim48_v7_training_hashes_v1",
    ...
    freeze_manifest = {
        "schema": "task1_picklift_real24_questsim48_v7_training_result_freeze_v1",
        "freeze_id": "task1_picklift_real24_questsim48_v7_act_v1_training_result_v1",
    ...
    dataset_result = {
        "schema": "task1_picklift_real24_questsim48_v7_dataset_result_index_v1",
    ...
    offline_result = {
        "schema": "task1_picklift_real24_questsim48_v7_offline_validation_index_v1",
        **summary["offline_validation"],
    }
    run_result = {
        "schema": "task1_picklift_real24_questsim48_v7_run_result_index_v1",
        "experiment_id": EXPERIMENT_ID,
        ...
        "controlled_contract": summary["config_contract"]["verification"]["controlled_contract"],
        "smoke": summary["smoke"],
    ...
    write_json(EXPERIMENT_ROOT / "combined72_result.json", dataset_result)

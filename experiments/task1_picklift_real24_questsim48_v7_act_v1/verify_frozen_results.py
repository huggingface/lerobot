...
def main() -> None:
    parser = argparse.ArgumentParser(description="Verify frozen Real24 + Sim48-v7 results")
    ...
    result = {
        "schema": "task1_picklift_real24_questsim48_v7_training_result_verification_v1",
        "status": "pass",

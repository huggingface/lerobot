...
def main() -> None:
    ...
    for trial in plan["trials"]:
        ...
        require(
            evidence["replacement_for"] == (original_stem if artifact_stem != original_stem else None),
        ...
        require(
            evidence["ready_pose_alignment"]["result"]["maximum_absolute_error"] <= 3.0,
        ...
        require(
            evidence["automatic_return"]["result"]["maximum_absolute_error"] <= 3.0,
    ...
    for cell_id in sorted({row["cell_id"] for row in selected}):
        ...
        mixed_success = cell["mixed_v2"]["operator_success"]

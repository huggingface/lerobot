...
PLAN_ID = "task1-picklift-real24-questsim24-act-mixed-v2"
DERIVED_DATASET_ID = "task1_picklift_real24_questsim24_combined48_v3"
...
SIM_SESSION_ROOT = Path(
    "/home/ubuntu24/SO101QuestRemote-data/formal/task1_picklift_quest_remote_mujoco_formal24_20260729_r1"
)
...
REMOTE_DEPLOYED_COMMIT = "1dfac5c108e830a55b114b1a75bd00bdb5d877b7"
...
def source_audit() -> tuple[dict, LeRobotDataset, LeRobotDataset]:
    ...
    audit = {
        "schema": "task1_picklift_combined48_source_compatibility_audit_v2",
        "plan_id": PLAN_ID,
        ...
        rows.append(
            {
                ...
                "source_subset_id": ("task1_picklift_quest_remote_mujoco_formal24_20260729_r1_accepted_v1"),
...
def main() -> None:
    ...
    try:
        ...
        image_stats = exact_video_stats(args.output_root, expected_frames=3790 + 4176)
        ...
        provenance_manifest = {
            "schema": "task1_picklift_combined48_provenance_v2",
            "plan_id": PLAN_ID,
        ...
        derived_manifest = {
            "schema": "task1_picklift_combined48_derived_manifest_v2",
            "plan_id": PLAN_ID,
            "dataset_id": DERIVED_DATASET_ID,
            "repo_id": DERIVED_REPO_ID,
            ...
            "domain_episode_counts": dict(sorted(domain_episodes.items())),
            "domain_frame_counts": dict(sorted(domain_frames.items())),
            "simulation_frame_fraction": domain_frames["remote_mujoco_human_quest"] / len(derived),
        ...
        freeze = {
            "schema": "task1_picklift_combined48_freeze_v2",

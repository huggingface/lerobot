...
EXPECTED_RESEARCH_IDENTITY_VERIFICATION_SHA256 = (
    "39149bc32a27c33172086656567d06ea9dd030765814245faabeb4b720d4f0e6"
)
EXPECTED_PLAN_SHA256 = "2d5f634bcf3f96d15711cbf43e6c10d123e26d91bbc74bd23e03338f19514e65"
...
EXPECTED_EVALUATION_ID = "task1_picklift_real24_offcenter_yaw_eval_v2_difficulty_pilot_v1"
EXPECTED_RESEARCH_COMMIT = "ca62d043d55a70f06c91a9b4ffdfcac16a63d5cd"
EXPECTED_RESEARCH_HASHES = {
    "protocol": "4975d82942843cadba3301c97f82617af669953b056cf18bc81dcf5ec6a4a55c",
    "pose_manifest": "4863646a12d5ae26b6d750f3db946d0a71aa479459710842f15722f60af4944b",
    "validation_manifest": "681b155cfa49380bed6f2ed7d887275a35ffa912cd8e9a2b3844306daa49a17a",
...
EXPECTED_POSE_SCHEDULE = (
    ("evalv2_pilot_r3c3", "r3c3", "x_minus_y_plus", 0),
    ("evalv2_pilot_r3c4", "r3c4", "x_minus_y_minus", 45),
    ("evalv2_pilot_r2c4", "r2c4", "x_minus_y_plus", 0),
    ("evalv2_pilot_r2c1", "r2c1", "x_plus_y_minus", 45),
    ("evalv2_pilot_r2c2", "r2c2", "x_plus_y_plus", 0),
    ("evalv2_pilot_r2c3", "r2c3", "x_minus_y_minus", 45),
    ("evalv2_pilot_r1c2", "r1c2", "x_minus_y_plus", 45),
    ("evalv2_pilot_r1c4", "r1c4", "x_plus_y_plus", 45),
    ("evalv2_pilot_r1c1", "r1c1", "x_minus_y_minus", 0),
    ("evalv2_pilot_r1c3", "r1c3", "x_plus_y_minus", 0),
    ("evalv2_pilot_r3c2", "r3c2", "x_plus_y_minus", 45),
    ("evalv2_pilot_r3c1", "r3c1", "x_plus_y_plus", 0),
)
...
def load_frozen_plan(path: Path = DEFAULT_PLAN) -> dict:
    ...
    if placement["operator_numeric_coordinate_entry_required"] is not False:
        raise RuntimeError("Operator must not be asked to type numeric coordinates.")

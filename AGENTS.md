...
- **Mypy**: one ruleset (`[tool.mypy]` in `pyproject.toml`) covers all of `src/lerobot` except `lerobot.rl` and the vendored `molmoact2_hf_model`. Add type annotations when modifying code.

...
Once rendered you can teleoperate the robot with the gamepad, below you can find the gamepad controls.
...
To evaluate your policy we have to use the config file that can be found here: `lerobot/examples/rl_config/gym_hil_serl_il_eval.json`

Then you can run this command to visualize your trained policy

<hfoption id="Linux">
```bash
python lerobot/scripts/rl/eval_policy.py --config_path=examples/rl_config/gym_hil_serl_il_eval.json

```
</hfoption>
<hfoption id="MacOS">
```bash
mjpython lerobot/scripts/rl/eval_policy.py --config_path=examples/rl_config/gym_hil_serl_il_eval.json
```
</hfoption>
</hfoptions>

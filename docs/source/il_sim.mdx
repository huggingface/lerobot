...
To use `gym_hil` with LeRobot, you need to use a configuration file. An example config file is stored under `lerobot/examples/rl_config/gym_hil_serl_il.json`.
...
<hfoption id="Linux">
```bash
python lerobot/scripts/rl/gym_manipulator.py --config_path examples/rl_config/gym_hil_serl_il.json

```
</hfoption>
<hfoption id="MacOS">
```bash
mjpython lerobot/scripts/rl/gym_manipulator.py --config_path examples/rl_config/gym_hil_serl_il.json
```
</hfoption>
</hfoptions>

...
<img src="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/lerobot/phone_teleop" alt="Phone teleop orientation" title="Phone teleop orientation" width="60%">

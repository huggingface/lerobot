...
SmolVLA is Hugging Face’s compact foundation model for robotics. We designed SmolVLA to make it easy to finetune on lerobot data, jumpstarting your development!
...
In addition to these instructions, you need to install the SmolVLA dependencies:

...
python lerobot/scripts/train.py \
  ...
  --dataset.repo_id=HF_USER/DATASET_NAME \ # <- Use your dataset
  --batch_size=64 \ # <- Adjust as your GPU allows it
  --steps=20000  # <- 10% of steps used to train the smolvla_base model. Adjust as needed
```
...
python -m lerobot.record \
  ...
  --teleop.port=/dev/ttyACM0 \ # <- Use your port
  --teleop.id=my_blue_leader_arm \ # <- Use your teleop id

...
- **Large flow-loss gradients:** joint prefix/action attention uses PyTorch SDPA
  by default, including when knowledge insulation is disabled. This avoids
  materializing attention scores in BF16, which can destabilize gradients at

...
python src/lerobot/scripts/lerobot_train.py \
  ...
  --policy.repo_id=your-username/your_repo_id \
...
python examples/rtc/eval_with_real_robot.py \
  --policy.path=nepyope/unitree_blue_box_16_full \
  --policy.device=cuda \
  --robot.type=unitree_g1 \
  --robot.is_simulation=false \
  --robot.locomotion=holosoma \
  --robot.cameras='{"global_view": {"type": "zmq", "server_address": "192.168.123.164", "port": 5555, "camera_name": "head_camera", "width": 640, "height": 480, "fps": 30}}' \
  --task="move box" \
  --duration=12004 \
  --fps=40 \
  --rtc.enabled=true

...
- **Record / Replay** feature for datasets
---
...
python -m lerobot.scripts.lerobot_record \
  ...
  --robot.cameras='{"global_view": {"type": "zmq", "server_address": "<YOUR_ROBOT_IP>", "port": 5555, "camera_name": "head_camera", "width": 640, "height": 480, "fps": 30}}' \
  --dataset.repo_id={YOUR_USERNAME/YOUR_DATASET} \
  --dataset.single_task="Test" \
  --dataset.num_episodes=5 \
  --dataset.episode_time_s=5 \

...
- **GR00T locomotion policiy** for bipedal walking and balance
...
NOTE: When running on the G1, change the IP to `127.0.0.1` and ensure the pip version matches the one in your environment by running `which pip`.

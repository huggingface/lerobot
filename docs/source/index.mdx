...
TODO(pepijn): Add license everywhere
TODO(pepijn): Make layout everywhere nice
TODO(pepijn): Check all text according to style guide

<div class="flex justify-center">
  <a target="_blank" href="https://huggingface.co/lerobot">
      <img alt="HuggingFace Expert Acceleration Program" src="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/lerobot/lerobot-logo-thumbnail.png" style="width: 100%">
  </a>
</div>

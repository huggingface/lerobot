...
<div class="border dark:border-gray-700 rounded-lg p-4 my-6 flex flex-col md:flex-row gap-4 items-center">
  <a
    target="_blank"
    href="https://huggingface.co/spaces/lerobot/visualize_dataset?path=/lerobot/svla_so101_pickplace/episode_0"
    class="shrink-0"
  >
    <img
      src="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/lerobot/visualizer-episode.webp"
      alt="The LeRobot Dataset Visualizer playing an SO-101 dataset"
      width="320"
    />
  </a>
  <div>
    <div class="text-lg font-semibold mb-1">👀 See a dataset first</div>
    <p class="text-gray-700 dark:text-gray-300 text-sm">
      ...
      <a
        ...
        href="https://huggingface.co/spaces/lerobot/visualize_dataset?path=/lerobot/svla_so101_pickplace/episode_0"
      >
        <code>lerobot/svla_so101_pickplace</code>
      </a>
      in the{" "}
      <a
        target="_blank"
      ...
      to watch its camera recordings next to the robot's state and actions,
      frame by frame, with nothing to install. It works for any LeRobot dataset
      on the Hub, including your own. See{" "}
      <a href="./using_dataset_tools#explore-a-dataset-in-the-browser">
        how to use it
      </a>
      .
    </p>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4 my-6">
  ...
  <div class="border dark:border-gray-700 rounded-lg p-4 shadow">
    ...
    <ul class="text-gray-700 dark:text-gray-300 text-sm list-disc pl-5 mb-2">
      <li>
        explore any dataset in the
        <a href="https://huggingface.co/spaces/lerobot/visualize_dataset">
          Dataset Visualizer
        </a>
      </li>
      <li>

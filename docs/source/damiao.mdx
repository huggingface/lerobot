...
```bash
# Setup single interface
lerobot-setup-can --mode=setup --interfaces can0

# Setup multiple interfaces (e.g., OpenArms with 4 CAN buses)
...
motors = {
    "joint_1": Motor(id=0x01, motor_type="dm8009", recv_id=0x11),
    "joint_2": Motor(id=0x02, motor_type="dm4340", recv_id=0x12),
    "joint_3": Motor(id=0x03, motor_type="dm4310", recv_id=0x13),
}

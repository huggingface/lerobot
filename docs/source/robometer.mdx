...
**Checkpoint**: [robometer/Robometer-4B](https://huggingface.co/robometer/Robometer-4B)
...
- [Original ROBOMETER code](https://github.com/aliang8/robometer)
- [Published ROBOMETER-4B checkpoint](https://huggingface.co/robometer/Robometer-4B)

...
[IsaacLab Arena](https://github.com/isaac-sim/IsaacLab-Arena) extends NVIDIA IsaacLab to provide:

- 🤖 **Humanoid embodiments**: GR1, G1, Galileo with various configurations
- 🎯 **Manipulation & loco-manipulation tasks**: Examples for Door opening, pick-and-place and button pressing
...
<Tip>
The IsaacLab Arena environemnts you build needs to be locally available during evaluation.
You can instruct users to clone them separately, but you can also include them in the EnvHub repo, along with all the assets!
</Tip>

Then, evaluating, use your new environment:

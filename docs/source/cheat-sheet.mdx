...
Depending on your hardware training the policy might take a few hours. For VLA models provide the path to the pretrained model. For `ACT` you don't need a path, just change the type.

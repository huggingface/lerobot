...
- Generates a visualization of the first episode (`sarm_progress_ep0.png`)
...
| `--no-visualize`      | Skip visualization of first episode                         | `false`           |
...
Once you have the progress file, train your policy with RA-BC weighting:

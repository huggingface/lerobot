...
```python
# examples/tutorial/sarm/visualize_annotations_example.py
...
```bash
python examples/tutorial/sarm/visualize_annotations_example.py
```
...
Add `accelerate launch --multi_gpu --num_processes=4` before the training command for faster training.
...
```python
# examples/tutorial/sarm/sarm_inference_visualization.py
...
```bash
python examples/tutorial/sarm/sarm_inference_visualization.py
```

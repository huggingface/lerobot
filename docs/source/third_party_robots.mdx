...
<table width="100%" style="display:table; width:100%; table-layout:fixed;">
  ...
  <tbody>
    <tr style="border:0">
      <td><a href="https://pypi.org/project/lerobot_robot_axol/">lerobot_robot_axol</a></td>
      <td>Plugin for the <a href="https://docs.almond.bot">Almond Axol</a> dual-arm robot on released LeRobot versions: robot <code>axol</code>, VR teleoperator <code>axol_vr</code>, and ZED camera <code>zed</code> (see also the in-repo <a href="./almond_axol">Almond Axol</a> integration).</td>
    </tr>
    <tr style="border:0">

...
| `query_kind`   | Caller-owned `text`              | Recipe behavior                                      | Result                     |
| -------------- | -------------------------------- | ---------------------------------------------------- | -------------------------- |
...
The message-rendering step consumes `query_kind` and `text`; they do not leak into model
...
while runtime `query_kind` plus `text` works in either mode. Existing semantic `messages`

...
# Use for inference
lerobot-eval \
  --policy-path=path/to/trained/model \
  --robot-path=path/to/robot/config
```
...
- [DitFlow Policy](https://github.com/danielsanjosepro/lerobot_policy_ditflow) - Diffusion Transformer policy

We encourage sharing your policy implementations with the community! 🤗

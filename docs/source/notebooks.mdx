...
Expected training time for 100k steps: ~1.5 hours on an NVIDIA A100 GPU.
...
Expected training time for 20k steps: ~5 hours on an NVIDIA A100 GPU. (Which can be improved with a larger batch size depending on your GPU memory)

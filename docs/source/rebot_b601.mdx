...
Motor communication and hardware validation are handled by MotorBridge. LeRobot propagates its transport and feedback errors directly instead of replacing missing positions with fabricated `0°` values.

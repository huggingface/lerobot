...
The `libero` extra pins `mujoco>=3.2.7,<3.4`. MuJoCo 3.4 and later change how `libero_spatial` task 5 settles at reset, so the bowl no longer sits on the ramekin. See [#4390](https://github.com/huggingface/lerobot/issues/4390).

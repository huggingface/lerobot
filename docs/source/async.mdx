...
python src/lerobot/scripts/server/robot_client.py \
    ...
    --policy_type=act \ # POLICY: the type of policy to run
    --pretrained_name_or_path=fracapuano/act_so100_test \ # POLICY: the model name/path on server to the checkpoint to run

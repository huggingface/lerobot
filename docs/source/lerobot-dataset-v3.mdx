...
See the [recording guide](https://huggingface.co/docs/lerobot/il_robots#record-a-dataset) for more details.
...
`LeRobotDataset` returns Python dictionaries of PyTorch tensors and integrates with `DataLoader`. Here is a code example showing its use:

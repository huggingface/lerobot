...
## Physical agent supervision and improvement

Use `lerobot-rollout --agent_config=examples/rebot_agent/session.json` for hybrid
VLA/tool control, correction recording, and recipe-based training experiments.
See the [physical agent loop guide](./physical_agent_loop).

...
The `--strategy.type` flag selects the execution mode. LeRobot ships these, and an installed third-party package can add its own (see [Bring Your Own Rollout Strategy](./bring_your_own_rollout_strategies)):

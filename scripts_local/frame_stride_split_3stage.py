"""Frame-stride train/val split for the 3-stage SARM dataset (100 eps).
...
Source: domrachev03/sim_assemble_sarm_multistage_three_stages_success
Outputs:
  - domrachev03/sim_3stage_train_fs
  - domrachev03/sim_3stage_val_fs
"""
...
SRC = "domrachev03/sim_assemble_sarm_multistage_three_stages_success"
N_STRIDE = 10
OUT_TRAIN = "domrachev03/sim_3stage_train_fs"
OUT_VAL = "domrachev03/sim_3stage_val_fs"
META_OUT = Path("outputs/sim_3stage_split_meta.json")

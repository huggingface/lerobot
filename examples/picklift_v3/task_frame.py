...
TASK_GRID_FRAME_ID = "picklift_task_grid_v1"

_TASK_FRAMES = {
    TASK_GRID_FRAME_ID: {
        "frame_id": TASK_GRID_FRAME_ID,
        "reference": "physical_mat_grid_aligned_with_mujoco_grid",
        "origin": {
            "description": (
                "SO-101 base rotation center projected onto the task plane, "
                "fixed at the mat bottom 30 cm mark"
            ),

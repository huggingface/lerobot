...
"""Evaluate a policy trained on a dataset recorded with examples/keyboard_to_so100/record.py.

The policy acts in end-effector space (``ee.*``); the keyboard is not used.
"""
...
def main():
    ...
    init_rerun(session_name="keyboard_so100_evaluate")

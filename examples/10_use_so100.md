...
```
Great :hugs:! You are now done installing LeRobot and we can begin assembling the SO100 arms. :robot:. Every time you now want to use LeRobot you can go to the folder (/lerobot) where we installed LeRobot via the cmd and run one of the commands.
...
<summary><strong>Video finding port</strong></summary>
  ...
  <video src="https://github.com/user-attachments/assets/98b7add9-2325-489b-abba-71374d4a70ea"></video>
</details>

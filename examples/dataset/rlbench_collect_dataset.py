...
def main(args):
    ...
    dataset = LeRobotDataset.create(
        ...
        features={
            ...
            **{f"observation.images.{cam}": {
                    ...
                    "info": { "video.fps": args.fps, "video.height": args.image_height, "video.width": args.image_width, "video.channels": 3, "video.is_depth_map": False, "has_audio": False }
    ...
    for i in tqdm(range(args.num_episodes), desc="Collecting demos"):
        # generate a new demo
        ...
        for frame_index, observation in enumerate(demo):
            ...
            if args.action_repr in ["euler", "quat"]:
                ...
                action = get_target_joints(demo, frame_index + 1 if frame_index < len(demo) - 1 else frame_index)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Collect RLBench demonstrations and save to LeRobot dataset format.")
    parser.add_argument(
        "--save_path",
        type=str,
    ...
    parser.add_argument(
        "--task",
        type=str,
        default="PutRubbishInBin",
        help="Name of the RLBench task."
    )
    parser.add_argument(
        "--action_repr",
        type=str,
    ...
    parser.add_argument(
        ...
        type=int,
        default=30,
        help="Video frames per second for the dataset (default: 30)."
    )
    parser.add_argument(
        "--image_width",
        type=int,

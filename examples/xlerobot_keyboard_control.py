...
def p_control_loop(robot, keyboard, target_positions, start_positions, current_positions, kp=0.5, control_freq=50):
    """
    P控制循环
    ...
    while True:
        try:
                ...
                for key, value in keyboard_action.items():
                    ...
                    # 第一臂xy控制
                        ...
                        if coord == 'x':
                            ...
                            joint2_target, joint3_target = inverse_kinematics(current_positions['left']['x'], current_positions['left']['y'])
                            target_positions['left_shoulder_lift'] = joint2_target
                            target_positions['left_elbow_flex'] = joint3_target
                            print(f"第一臂更新x坐标: {current_positions['left']['x']:.4f}, joint2={joint2_target:.3f}, joint3={joint3_target:.3f}")
                        elif coord == 'y':
                            ...
                            target_positions['left_shoulder_lift'] = joint2_target
                            target_positions['left_elbow_flex'] = joint3_target
                            print(f"第一臂更新y坐标: {current_positions['left']['y']:.4f}, joint2={joint2_target:.3f}, joint3={joint3_target:.3f}")
                    ...
                    # 第二臂xy控制
                        ...
                        if coord == 'x':
                            ...
                            # 计算joint2和joint3的目标角度
                            joint2_target, joint3_target = inverse_kinematics(current_positions['right']['x'], current_positions['right']['y'])
                            target_positions['right_shoulder_lift'] = joint2_target
                            target_positions['right_elbow_flex'] = joint3_target
                            print(f"第二臂更新x坐标: {current_positions['right']['x']:.4f}, joint2={joint2_target:.3f}, joint3={joint3_target:.3f}")
                        elif coord == 'y':
                            ...
                            target_positions['right_shoulder_lift'] = joint2_target
                            target_positions['right_elbow_flex'] = joint3_target
                            print(f"第二臂更新y坐标: {current_positions['right']['y']:.4f}, joint2={joint2_target:.3f}, joint3={joint3_target:.3f}")
            
            # 对每个机械臂应用pitch调整到wrist_flex
            if 'left_shoulder_lift' in target_positions and 'left_elbow_flex' in target_positions:
                target_positions['left_wrist_flex'] = - target_positions['left_shoulder_lift'] - target_positions['left_elbow_flex'] + pitch['left']
            
            if 'right_shoulder_lift' in target_positions and 'right_elbow_flex' in target_positions:
                target_positions['right_wrist_flex'] = - target_positions['right_shoulder_lift'] - target_positions['right_elbow_flex'] + pitch['right']
            ...
            if p_control_loop.step_counter % 100 == 0:
                ...
                print(f"当前底盘速度: x={base_velocities['x.vel']:.3f}, y={base_velocities['y.vel']:.3f}, theta={base_velocities['theta.vel']:.3f}")
...
def main():
    ...
    try:
        ...
        # 开始P控制循环
        p_control_loop(robot, keyboard, target_positions, start_positions, current_positions, kp=0.5, control_freq=50)

...
#SBATCH --job-name=lerobot_base_distributed_aloha_transfer_cube_act_1gpus_noaccelerate
#SBATCH --nodes=1
...
#SBATCH --output=/data/mshukor/logs/slurm/lerobot_base_distributed_aloha_transfer_cube_act_1gpus_noaccelerate.out
...
# TASK_NAME=lerobot_base_distributed_${ENV}_transfer_cube_${policy}_2gpus_noamp
...
# TASK_NAME=lerobot_base_distributed_${ENV}_transfer_cube_${policy}_1gpus_noaccelerate_bs64
...
# GPUS=3
# EVAL_FREQ=3300 #51000 #10000 51000
# OFFLINE_STEPS=17000 #25000 17000 12500 50000


# ### Pusht
# GPUS=1
# EVAL_FREQ=20000 #51000 #10000 51000
...
# OFFLINE_STEPS=50000 #25000 17000 12500 50000
...
# MUJOCO_GL=egl python -m accelerate.commands.launch --num_processes=$GPUS lerobot/scripts/train.py \
#  hydra.job.name=base_distributed_aloha_transfer_cube \
#  hydra.run.dir=/data/mshukor/logs/lerobot/${TASK_NAME} \
#  dataset_repo_id=$dataset_repo_id \
#  policy=$policy \
...
# MUJOCO_GL=egl python examples/slurm/test_gym.py
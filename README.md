...
Here are the commands I've been running:

python lerobot/scripts/eval.py --policy.path=outputs/train/2025-06-10/16-01-31_pusht_diffusion/checkpoints/last/pretrained_model --output_dir=fancy_eval_outputs --env.type=pusht --eval.n_episodes=50 --eval.batch_size=50

python lerobot/scripts/visualize_dataset.py --eval-data-dir fancy_eval_outputs/eval_data --episode-index 0

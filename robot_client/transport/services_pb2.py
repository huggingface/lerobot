...
# Backward compatibility with protobuf < 6 (no runtime_version module)
try:
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'robot_client.transport.services_pb2', _globals)

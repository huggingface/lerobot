...
try:
    from robot_client.transport import services_pb2 as lerobot_dot_transport_dot_services__pb2
except Exception:  # noqa: BLE001
    from transport import services_pb2 as lerobot_dot_transport_dot_services__pb2  # type: ignore
...
if _version_not_supported:
    warnings.warn(
        ...
        f'but these stubs were generated against grpcio>={GRPC_GENERATED_VERSION}. '
        f'Proceeding anyway due to relaxed compatibility check.',
        RuntimeWarning,
    )
